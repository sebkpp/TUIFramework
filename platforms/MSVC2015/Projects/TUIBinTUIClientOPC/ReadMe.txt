========================================================================
    KONSOLENANWENDUNG: TUIBinTUIClientOPC-Projektübersicht
========================================================================

Diese TUIBinTUIClientOPC-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre TUIBinTUIClientOPC-Anwendung besteht.


TUIBinTUIClientOPC.vcxproj
...
TUIBinTUIClientOPC.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen TUIBinTUIClientOPC.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
