========================================================================
    DYNAMIC LINK LIBRARY: TUILibXControllerDemuxDLL-Projektübersicht
========================================================================

Diese TUILibXControllerDemuxDLL-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre TUILibXControllerDemuxDLL-Anwendung besteht.


TUILibXControllerDemuxDLL.vcxproj
...
TUILibXControllerDemuxDLL.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen TUILibXControllerDemuxDLL.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
