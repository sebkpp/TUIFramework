========================================================================
    STATISCHE BIBLIOTHEK: TUILibMotionCaptureStub-Projektübersicht
========================================================================

Dieses TUILibMotionCaptureStub-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Es wurden keine Quelldateien als Teil des Projekts erstellt.


TUILibMotionCaptureStub.vcxproj
...
TUILibMotionCaptureStub.vcxproj.filters
