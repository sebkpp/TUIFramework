...
public:
	...
	* enable Asynch IO
	*/
	void enableAsynch(IAsynchDataCallback &handler, tuiframework::IEventSink * eventSink, tuiframework::DeviceDescriptor deviceDescriptor, int entityID,CString blockWriteVariable);
