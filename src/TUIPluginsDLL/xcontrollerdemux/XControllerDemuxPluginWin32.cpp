...
void dllInitPlugin() {
	MSPFactorySingleton::getInstance()->registerCreateFunction(XControllerDemuxMSP::getMSPTypeName(), XControllerDemuxMSP::createFunction);
    mspTypeNameVector.push_back(XControllerDemuxMSP::getMSPTypeName());
}
...
void dllMSPRegistration(IMSPFactory * MSPFactory) {
    MSPFactory->registerCreateFunction(XControllerDemuxMSP::getMSPTypeName(), XControllerDemuxMSP::createFunction);
}
