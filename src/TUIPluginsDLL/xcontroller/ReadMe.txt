========================================================================
    DYNAMIC LINK LIBRARY: TUILibXControllerDLL-Projektübersicht
========================================================================

Diese TUILibXControllerDLL-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre TUILibXControllerDLL-Anwendung besteht.


TUILibXControllerDLL.vcxproj
...
TUILibXControllerDLL.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen TUILibXControllerDLL.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
