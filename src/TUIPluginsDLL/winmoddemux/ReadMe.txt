========================================================================
    DYNAMIC LINK LIBRARY: TUILibWinModDemuxDLL-Projektübersicht
========================================================================

Diese TUILibWinModDemuxDLL-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre TUILibWinModDemuxDLL-Anwendung besteht.


TUILibWinModDemuxDLL.vcxproj
...
TUILibWinModDemuxDLL.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen TUILibWinModDemuxDLL.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
