...
namespace tuiframework {
	...
	void dllInitPlugin() {
		MSPFactorySingleton::getInstance()->registerCreateFunction(Mapper::getMSPTypeName(), Mapper::createFunction);
		mspTypeNameVector.push_back(Mapper::getMSPTypeName());
	}
	...
	void dllMSPRegistration(IMSPFactory * MSPFactory) {
		MSPFactory->registerCreateFunction(Mapper::getMSPTypeName(), Mapper::createFunction);
	}
