...
IF %xmlchoice%==0 (
	set xmlConfiguration=./xmlconfig/TUIconfig_winMOD_ProjectFloGol_ohneByte_v2.xml
) ELSE (
...
start "Python Interface Output" python35_d python_interface_JSON_TCP.py %xmlConfiguration%