...
private:
	...
	*/
	...
	void push(tuiframework::IEvent * event) {
...
public:
	...
	void setData( tuiframework::DeviceDescriptor deviceDescriptor,int entityID, tuiframework::IEventSink* eventSink,CString blockWriteVariable)
	{
		this->deviceDescriptor = deviceDescriptor;
		this->eventSink = eventSink;
		this->entityID = entityID;
		this->blockWriteVariable = blockWriteVariable;
	...
	*/
		...
		HRESULT * errors)
	{
		...
		if (usrHandler){
			...
			usrHandler->OnDataChange(callbacksGroup, dataChanges,this->eventSink,this->deviceDescriptor,this->entityID,this->blockWriteVariable);
		}
		return S_OK;
	}
...
int COPCGroup::addItems(CAtlArray<CString>& itemName, CAtlArray<COPCItem *>& itemsCreated, CAtlArray<HRESULT>& errors, bool active){
	...
	//cout << "ItemName Count: "<< noItems << endl;
	//cout << "ItemDef: " << itemDef << endl;
...
void COPCGroup::enableAsynch(IAsynchDataCallback &handler, tuiframework::IEventSink * eventSink, tuiframework::DeviceDescriptor deviceDescriptor, int entityID,CString blockWriteVariable){
	...
	asynchDataCallBackHandler->setData(deviceDescriptor, entityID, eventSink, blockWriteVariable);
