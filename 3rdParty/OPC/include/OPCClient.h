...
{
public:
	virtual void OnDataChange(COPCGroup & group, CAtlMap<COPCItem *, OPCItemData *> & changes, tuiframework::IEventSink * eventSink, tuiframework::DeviceDescriptor deviceDescriptor, int entityID,CString blockWriteVariable) = 0;
};
